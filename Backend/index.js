...
var forms = new Nedb({ filename: 'Route/Form/data.db', autoload: true });
var formData = new Nedb({ filename: 'Route/Form/formData.db', autoload: true });
...
function init(req, res) {
    forms.insert(
        {
            formName: 'Test Form',
            formDesc: 'This is a Testing Form',
            data: [
                {
